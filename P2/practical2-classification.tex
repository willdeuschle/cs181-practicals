...
\item \verb|sample_predictions.csv| -- A sample submission file.  You will produce a similar file.  The format is comma-delimited, with the first column being the \verb|hex_string| and the second column being your class prediction, an integer between 0 and 14 (inclusive).
\begin{csv}
Id,Prediction
